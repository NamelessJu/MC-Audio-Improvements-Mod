...
{
    private static final Component SUFFIX_SECONDS = Component.translatable("audioimprovements.config.option.musicFrequency.seconds");
    private static final Component SUFFIX_MINUTES = Component.translatable("audioimprovements.config.option.musicFrequency.minutes");
    ...
    public static final MusicFrequencyValue[] VALUES = new MusicFrequencyValue[] {
        ...
        new MusicFrequencyValue(60, false),
    ...
    public static ValueListSlider<MusicFrequencyValue> createConfigSlider(IntegerEntry configEntry, @Nullable BiConsumer<Integer, MusicFrequencyValue> onValueChanged)
    {
        return new ValueListSlider<>(0, 0, 0, 20,
            configEntry.getNameComponent(), MusicFrequencyValue.VALUES, getClosestFromTicks(configEntry.value),
            (index, value) -> {
                configEntry.value = value.ticks;
